...
#Define histograms
h_mu_nJets_vs_AK4HT = ROOT.TH2F("NJets_vs_AK4HT_mu", "AK4 Jet HT vs. nJets in the Event for TTSemiLep  Mu Events; nJets; AK4HT (GeV)", 8, 6, 13, 50, 400, 1200) #maybe tweak this

h_el_nJets_vs_AK4HT = ROOT.TH2F("NJets_vs_AK4HT_el", "AK4 Jet HT vs. NJets in the Event for TTSemiLep  El Events; nJets; AK4HT (GeV)", 8, 6, 13, 50, 400, 1200)
