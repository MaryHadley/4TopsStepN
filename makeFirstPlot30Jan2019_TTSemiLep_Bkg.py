...
f = ROOT.TFile("Mary_test_TTSemiLep_17_MC_Bkg_6_Feb_2019_comb.root")
...
h_mu_nJets_vs_AK4HT.Scale(25.) #lumi recorded in 2017 is 45 inv  fb, cross section for TTSemiLep  is (831000*0.438) fb aka 363978 fb (this info on inclusive xsec times BF comes from Julie), nEventsGenerated before any cuts is 659411 for the file files I ran over
...
#ROOT.gStyle.SetStatX(.7)
ROOT.gStyle.SetOptStat(0)
h_el_nJets_vs_AK4HT.Scale(25.) #lumi recorded in 2017 is 45 inv fb, cross section for TTSemiLep  is (831000 * .438)  fb aka 363978 fb, nEventsGenerated before any cuts is 659411 for the file files I ran over
